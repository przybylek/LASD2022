...
const Header = () => (
  <Jumbotron style={{ backgroundImage: `url(/landingPage.jpg)`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}  className='mt-5'>
    ...
    <p className='text-center lead text-info font-italic'>Corresponding authors of 20 top-rated accepted papers will get complimentary 1 year membership in <a href='https://www.agilealliance.org'>Agile Alliance</a>! <span className='badge badge-warning'>pending request</span></p>
