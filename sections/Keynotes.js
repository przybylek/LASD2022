...
const KeynoteSpeakers = () => (
  <Container className='section'>
    ...
    <dl>
      <dt>Keynote title</dt>
      <dd>Agility in Software 2.0 – Notebook Interfaces and MLOps with Buttresses and Rebars</dd>
