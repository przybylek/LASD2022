  ...
  <Container className="bg-light">
    ...
    <h2 className="display-4 anchor">Topics and Interests</h2>
      <ListGroup variant='flush' >
        ...
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Conflicts in agile teams</ListGroup.Item>
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Lean and agile project production and management</ListGroup.Item>
        ...
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Managing knowledge for agility and collaboration</ListGroup.Item>
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Tools and techniques for lean and agile development</ListGroup.Item>
        ...
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Innovation and creativity in software engineering</ListGroup.Item>
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Variability across the software life cycle</ListGroup.Item>
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Gamification</ListGroup.Item>
        <ListGroup.Item className="bg-light"><i className="fas fa-check-square"/> Industrial experiments, case studies, and experience reports related to all of the above topics</ListGroup.Item>
      </ListGroup>
  </Container>
)
